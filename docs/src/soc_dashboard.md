# Observability and SOC Dashboard

---

![Next.js SOC Dashboard](soc_dashboard.png)
_Figure 1: The Rudras SOC Dashboard displaying live analytics and threat telemetry._
