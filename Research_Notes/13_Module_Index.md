# Research Note 13: Complete Module Index and Cross-Reference
...
> Note: The remaining 30+ source files in the `src/` directory are specialized research and advanced modules. They are documented in Research Note 10 (Research-Grade Modules) and listed in Section 4 of this index.
...
`distributed_immunity.rs`, `process_monitor.rs`, and all modules documented in Research Note 10 (Research-Grade Modules).
...
9. **Update Research Notes** — add a section to the appropriate deep-dive document (files 6-12) or create a new one
